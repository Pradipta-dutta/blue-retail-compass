...
import { Package, Bell, CheckSquare, LogOut, Menu, X, User } from 'lucide-react';
...
const EmployeeLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/employee', icon: Package },
    { name: 'Alerts', href: '/employee/alerts', icon: Bell },
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      <div className="lg:ml-64">
        ...
        <div className="lg:hidden flex items-center justify-between h-16 px-4 bg-white shadow-sm border-b">
          ...
          <h1 className="text-lg font-semibold text-store-blue">Employee Portal</h1>
          <div className="w-10" />
        </div>
